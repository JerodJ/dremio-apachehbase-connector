...
@SourceType(value = "ApacheHBaseARP", label = "ApacheHBase",uiConfig = "apachehbase-layout.json")
public class ApacheHBaseConf extends AbstractArpConf<ApacheHBaseConf> {
  private static final String ARP_FILENAME = "arp/implementation/apachehbase-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apachehbase.ApacheHBaseDriver";
